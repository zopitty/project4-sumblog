...
export default function NavBar() {
  return (
    <nav className="left-0 top-0 z-20 mb-4 w-full border border-gray-200 bg-gray-200 shadow-sm">
      <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        <Link href="/">
          <span className="font-circular leading-150 order-0 h-[42px] w-[111px] flex-none flex-grow-0 text-base font-medium text-black">
            sumblog
          </span>
        </Link>
